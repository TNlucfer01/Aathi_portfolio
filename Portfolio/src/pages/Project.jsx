...
function Project({ projectTittle, projectDescription, image, projectlink }) {
  return (
    <div className={` border-cyan-700 shadow-cyan-500  lg:hover:shadow-cyan-500 lg:hover:bg-gray-900 bg-gray-900 lg:hover:shadow-lg  duration-400 group hover:scale-105   min-h-80 justify-center  flex-col flex items-center lg:m-8 lg:p-9 md:m-6 md:p-7 m-2 p-3 lg:border-4 md:border-3 border-2 rounded-3xl`}>
