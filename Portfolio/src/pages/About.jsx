...
function About() {
  ...
  return (
    ...
    >
      ...
      <p className="   lg:mr-10  lg:border-4 md:border-3 border-2 transform hover:scale-105 transition-all ease-in-out hover:shadow-cyan-500 hover:bg-gray-900 hover:shadow  text-base  duration-400 rounded-2xl border-cyan-700 lg:p-8 md:p-8 lg:ml-30 md:ml-30 ml-10 p-4 lg:text-2xl md:text-xl leading-relaxed text-gray-200  tracking-tight lg:mb-4 md:mb-3 mb-2">
